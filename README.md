...
The `env` Command will generate a whole list of environment variables. Within this list, we can locate our SHELL environment - `SHELL=/bin/bash` as well as HOME environment - `HOME=/home/coder`.

To clear out  the screen, simply use type `clear` in the CLI.
